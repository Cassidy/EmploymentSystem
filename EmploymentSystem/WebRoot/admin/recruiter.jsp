...
<html>
  ...
  <body>
	<center>
	  ...
	  <form action="./admin/recruiter.jsp" />
	...
	<%
	  ...
	  */
	  ...
	  String sql = "SELECT * FROM recruiters "+
		  "WHERE Zuser LIKE '%"+username+"%' "+
		  "AND Zpassword LIKE '%"+password+"%' "+
		  // "AND Ztel LIKE '%"+tel+"%' "+
		  // "AND Zmail LIKE '%"+email+"%' "+
		  "AND Zintro LIKE '%"+intro+"%'"+
		  ""; // 当数据库里某一列为空时,查询不成功
...
<!--	<td><b>电话</b></td>  -->
		...
		<td><b>简介</b></td>
		<td><b>操作</b></td>
		<td><b><a href="./admin/add_recruiter.jsp">增加</a></b></td>
	  </tr>
	  <%
	  ...
	  <tr>
		...
		<td><a href="./admin/modify_recruiter.jsp?username=<%=rs.getString(1) %>">修改</a></td>
		<td><a href="./admin/delete_recruiter.jsp?username=<%=rs.getString(1) %>">删除</a></td>
	  </tr>
	  <%
		}
		rs.close();
